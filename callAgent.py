...
def make_call(to_phone_number):
    local_server_url = "https://three-rabbits-melt.loca.lt/voice"  # Local server URL
...
def run_flask():
    app.run(port=5000, debug=True, use_reloader=False)  # Set `use_reloader=False` to avoid double app run
